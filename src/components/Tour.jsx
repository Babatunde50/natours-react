...
import cardPicture from '../assets/img/tour-2-1.jpg';
import { ReactComponent as Icon } from '../assets/img/icons.svg'
		...
		<div className="card">
			<div className="card__header">
				<div className="card__picture">
					...
					<img src={cardPicture} alt="Tour 1" className="card__picture-img" />
				</div>
            ...
            <a href="hjhj" className="btn btn--green btn--small">Details</a>
            </div> 
		</div>
	);
}
